...
const MessageIcon = ({ size }: Props) => (
  ...
  >
    ...
    <path
      ...
      strokeMiterlimit={10}
      strokeWidth={1.739}
      d="M12.003 2.001a9.705 9.705 0 1 1 0 19.4 10.88 10.88 0 0 1-2.895-.384.798.798 0 0 0-.533.04l-1.984.876a.802.802 0 0 1-1.123-.708l-.054-1.78a.807.807 0 0 0-.27-.569 9.49 9.49 0 0 1-3.14-7.175 9.65 9.65 0 0 1 10-9.7Z"
    />
    <path
      fill="#000"
      fillRule="evenodd"

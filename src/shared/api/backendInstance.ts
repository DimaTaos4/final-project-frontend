...
const {
  VITE_API_USERS_URL,
  VITE_API_POSTS_URL,
  VITE_API_NOTIFICATIONS_URL,
  VITE_API_CHATS_URL,
  VITE_API_MESSAGES_URL,
} = import.meta.env;
...
export const backendInstanceChats = axios.create({
  baseURL: VITE_API_CHATS_URL,
});

export const backendInstanceMessages = axios.create({
  baseURL: VITE_API_MESSAGES_URL,
});
